...
namespace Lcps.Infrastructure
{
    public class LcpsRepositoryContext : IdentityDbContext<DirectoryMember>, iDivisionDirectoryRepository
    {
        public LcpsRepositoryContext()
            : base(Lcps.DivisionDirectory.Properties.Settings.Default.ConnectionString, throwIfV1Schema: false)
        {
        ...
        {
            Lcps.DivisionDirectory.Properties.Settings.Default.ConnectionString = connectionNameOrString;
        }
